...
<html lang="ja">
    ...
    <body>
                ...
                <table class="search_main">
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="submit" id="btn_search" value="■□検索■□" class="button_container">
                        </td>
                        <td>
                            <span class="font14"><a href="./cart.php">カート</span><img class="icon" src="./view/image/cart.jpg">
                        </td>
                        <td>
        ...
        <div class="mainview">
            <img class="main_image" name="myimage" src="./view/image/slide1.jpeg">
        </div>
        ...
        function switchImage(){
            current++;
            document.images['myimage'].src ='./view/image/slide' + current + '.jpeg';
        if(current < numIMG){
            setTimeout("switchImage()", 3000);
            }
        }
        ...
        <main class="main">
            <nav class="nav">
                <section>
                    <h1 class="category"><a style ="color:white" href="./itemlist.php">熱帯のフルーツ</a></h1>
