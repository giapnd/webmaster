...
<html jang="ja">
    ...
    <body>
        <header id="fh5co-header">
            <div class="container-fluid">
                ...
                <table class="fh5co-social">
					...
					<td>
                        <?php if(isset($_COOKIE['account_name'])) {?>
                            <span class="items"><a href="./report.php">帳票<img src="view/images/report.png" class="icon"></a></span>
                        <?php } ?>
					</td>
					<td>
					    <?php if(isset($_COOKIE['account_name'])) {?>                    
        ...
        <?php if(!isset($_COOKIE['account_name'])) {?>
            <?php print '<p>購入するためログインしてください！</p>' ;?>
        <?php }?>
        ...
        <div class="group_list">
            ...
            <div class="category"><?php print $read['category'] ;?>
            ...
            <?php }?>       
        <?php }else {?>
            <?php print '購入完了しましたので他の商品を選択してください。';?>
        <?php }?>
